 @extends('layouts.vertical', ['title' => 'Rekam BAST Senjata Api'])
 ...
 @section('content')
     <div class="container-fluid">
         <form action="{{ route('bast-senjata-api.store') }}" method="POST">
             @csrf
                             ...
                             <div class="card">
                                 <div class="card-body">
                                     ...
                                     <div class="tab-content p-3 text-muted">
                                         <input type="hidden" id="id_bast_senjata_api" name="id_bast_senjata_api"
                                             value="">
                                             ...
                                             <div class="container-fluid mt-4">
                                                 ...
                                                 <div class="row mb-4 align-items-center text-black">
                                                     ...
                                                     <div class="col-md-10 col-sm-12 text-center">
                                                         ...
                                                         <p class="small mb-0">KANTOR PELAYANAN UTAMA BEA DAN amunisi TIPE B
                                                             BATAM</p>
                                                         <p class="small mb-0">
                                                 ...
                                                 <div class="mb-3 row align-items-center">
                                                     <div class="input-group flex-wrap">
                                                         ...
                                                         <input type="text" class="form-control"
                                                             value="{{ old('no_bast_senjata_api', $no_ref->no_bast_senjata_api) }}"
                                                         ...
                                                         <div class="row">
                                                             <div class="col-lg-12">
                                                                 <div class="container-fluid px-0 px-sm-3">
                                                                     ...
                                                                     <br>
                                                                     <p class="text-black">Bahwa <b>PIHAK KEDUA</b> telah
                                                                                     ...
                                                                                     <thead>
                                                                                         <tr class="bg-light">
                                                                                             ...
                                                                                             <th class="px-3 text-center py-3"
                                                                                                 ...
                                                                                                 Kategori BAST</th>
                                                                                             <th class="px-3 text-center py-3"
                                                                                                 style="width: 35%">Senjata
                                                                                                 Api</th>
                                                                                             <th class="px-3 text-center py-3"
                                                                                                 style="width: 15%">Jenis
                                                                                                 Amunisi</th>
                                                                                             <th class="px-3 text-center py-3"
                                                                                                 style="width: 15%">
                                                                                                 kaliber_senjata
                                                                     ...
                                                                     <p class="text-black">kepada PIHAK PERTAMA. PIHAK
                                                                         ...
                                                                         kesempatan pertama menerima dan saat mengembalikan
                                                                         senjata dan amunisi tersebut.</p>

                                                                     <br>
                                                                     <p class="text-black">
                                                                         Demikian Berita Acara ini dibuat dengan sebenarnya,
                                                                         kemudian ditutup dan ditandatangani di Banda Aceh
     ...
     <script>
         ...
         function generateUniqueID() {
             ...
             return `id_bast_senjata_api_${timestamp}_${randomNum}`;
         }
         ...
         document.addEventListener('DOMContentLoaded', function() {
             ...
             if (idBastSenjataApiInput) {
                 idBastSenjataApiInput.value = generateUniqueID(); // Jika ID Penyidikan tidak ada, buat ID baru
             }
