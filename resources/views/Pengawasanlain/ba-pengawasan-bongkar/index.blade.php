@extends('layouts.vertical', ['title' => 'B.A Pengawasan Bongkar'])
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3 mt-4">
            <div class="card-header">
                <h5 class="card-title mb-0">Berita Pengawasan Bongkar</h5>
            </div>
            <div class="card-body">
                <form method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label>No. B.A Pengawasan Bongkar</label>
                            <input type="text" class="form-control" name="passport_number" placeholder="Keyword">
                        </div>

                        <div class="col-md-4 mb-3">
                            <label>Tgl. B.A Pengawasan Bongkar:</label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label>Lokasi Pengawasan Bongkar:</label>
                        ...
                        <div class="col-12 d-flex justify-content-center flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                ...
                                <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Data B.A
                                Pengawasan Bongkar
                            </button>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary pilih-laporan"
                                                data-nomor="{{ $penyidikan->id_penyidikan }}">
                                                Pilih
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <table id="fixed-header-datatable" class="table table-hover align-middle border-separate"
                            ...
                            <thead>
                                <tr class="bg-light">
                                    ...
                                    <th class="px-3 text-center py-3" style="width: 10%">No BA Pengawasan Bongkar</th>
                                    <th class="px-3 text-center py-3" style="width: 15%">Tanggal Ba Pengawasan Bongkar
                                    </th>
                                    <th class="text-center px-3 py-3" style="width: 20%">Opsi</th>
                                </tr>
                            </thead>
                            <tbody align="center">
                                @foreach ($bongkar as $index => $bongkar)
                                    <tr class="shadow-sm">
                                        <td class="text-center fw-medium">{{ $index + 1 }}.</td>
                                        <td class="fw-medium">{{ $bongkar->no_pendaftaran_ba_bongkar }}</td>
                                        <td class="fw-medium">{{ $bongkar->tgl_pendaftaran_ba_bongkar }}</td>
                                        <td>
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="{{ route('ba-pengawasan-bongkar.edit', ['ba_pengawasan_bongkar' => $bongkar->id]) }}"
                                                    class="btn btn-soft-success btn-icon btn-sm rounded-pill">
                                                    <i data-feather="edit" class="icon-sm"></i> Edit
                                                </a>
                                                <form action="{{ route('ba-pengawasan-bongkar.destroy', $bongkar->id) }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-bs-target="#modalPrint{{ $bongkar->id }}">
                                                    <i data-feather="printer" class="icon-sm"></i> Print
                                                </button>
                                            </div>

                                        </td>
                                        <div class="modal fade" id="modalPrint{{ $bongkar->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header border-bottom-0 pb-0">
                                                        <h5 class="modal-title" id="printModalLabel">Print Dokumen
                                                            Pengawasan Bongkar</h5>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="card print-card border-primary shadow-lg">
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <h6 class="card-title mb-3">BA BONGKAR</h6>
                                                                            <a href="{{ route('ba-bongkar.print', $bongkar->id) }}"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="card print-card border-success shadow-lg">
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <h6 class="card-title mb-3">LPT BA BONGKAR</h6>
                                                                            <a href="{{ route('lpt-ba-bongkar.print', $bongkar->id) }}"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="card print-card border-warning shadow-lg">
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <h6 class="card-title mb-3">LPP BA BONGKAR</h6>
                                                                            <a href="{{ route('lpp-ba-bongkar.print', $bongkar->id) }}"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.addEventListener('click', function(event) {
                if (event.target.classList.contains('pilih-laporan')) {
                    ...
                    let buttonLabel = event.target.getAttribute(
                        'data-label'); // Ambil label tombol dari data-label
                    let url =
                        `/Pengawasanlain/ba-pengawasan-bongkar/create?id_penyidikan=${encodeURIComponent(nomorLaporan)}`;
