...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('ba-pengawasan-bongkar.update', ['ba_pengawasan_bongkar' => $bongkar->id]) }}" method="POST"
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="id_ba_bongkar" value="">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-6">
                                                        <div class="input-group">
                                                            <span class="input-group-text text-black bg-white border-0">
                                                                NOMOR PENDAFTARAN:
                                                            </span>
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="no_pendaftaran_ba_bongkar"
                                                                value="{{ old('no_pendaftaran_ba_bongkar', $bongkar->no_pendaftaran_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('tgl_pendaftaran_ba_bongkar', $bongkar->tgl_pendaftaran_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('nomor_tanggal_bc_ba_bongkar', $bongkar->nomor_tanggal_bc_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 text-black align-items-center">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('nama_sarana_ba_bongkar', $bongkar->nama_sarana_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('tanggal_realisasi_ba_bongkar', $bongkar->tanggal_realisasi_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('lokasi_pembongkaran', $bongkar->lokasi_pembongkaran) }}" />
                                                        </div>
                                                    </div>

                                                    <!-- 5a. Jam / Tgl dimulai Pembongkaran -->
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('jam_tgl_mulai_ba_bongkar', $bongkar->jam_tgl_mulai_ba_bongkar) }}" />
                                                        </div>
                                                    </div>

                                                    <!-- 5b. Jam / Tgl selesai Pembongkaran -->
                                                    <div class="row mb-2 align-items-center text-black">
                                                        <div class="col-5 ps-5">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('jam_tgl_selesai_ba_bongkar', $bongkar->jam_tgl_selesai_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('nomor_tgl_bill_of_lading_ba_bongkar', $bongkar->nomor_tgl_bill_of_lading_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('jumlah_barang_dibongkar_ba_bongkar', $bongkar->jumlah_barang_dibongkar_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('dokumen_pelengkap_ba_bongkar', $bongkar->dokumen_pelengkap_ba_bongkar) }}" />
                                                        </div>
                                                    </div>

                                                    <!-- 10a. Barang tidak ada ditempat -->
                                                    <div class="row mb-2 align-items-center text-black">
                                                        <div class="col-5 ps-5">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('barang_tidak_ada_ditempat_ba_bongkar', $bongkar->barang_tidak_ada_ditempat_ba_bongkar) }}" />
                                                        </div>
                                                    </div>

                                                    <!-- 10b. Barang sudah dibongkar -->
                                                    <div class="row mb-2 align-items-center text-black">
                                                        <div class="col-5 ps-5">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('barang_sudah_dibongkar_ba_bongkar', $bongkar->barang_sudah_dibongkar_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('lain_ba_bongkar', $bongkar->lain_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center text-black">
                                                        ...
                                                        <div class="col-6">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('keterangan_ba_bongkar', $bongkar->keterangan_ba_bongkar) }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="d-flex justify-content-start mb-3">
                                                            <div style="width: 70%;">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('agen_ba_bongkar', $bongkar->agen_ba_bongkar) }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <select class="form-control form-select select2"
                                                            ...
                                                            @foreach ($users as $user)
                                                                <option value="{{ $user->id_admin }}"
                                                                    {{ old('pejabat_pemeriksa_barang', $bongkar->pejabat_pemeriksa_barang) == $user->id_admin ? 'selected' : '' }}>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('surat_tugas_nomor_ba_bongkar_lpt', $bongkar->surat_tugas_nomor_ba_bongkar_lpt) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <select class="form-control form-select select2"
                                                                ...
                                                                @foreach ($users as $user)
                                                                    <option value="{{ $user->id_admin }}"
                                                                        {{ old('petugas_ba_bongkar_lpt', $bongkar->petugas_ba_bongkar_lpt) == $user->id_admin ? 'selected' : '' }}>
                                                                        {{ $user->name }} | {{ $user->jabatan }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('hari_tanggal_pemeriksaan_ba_bongkar_lpt', $bongkar->hari_tanggal_pemeriksaan_ba_bongkar_lpt) }}" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="border border-dark p-2" style="height: 300px;">
                                                        ...
                                                        <textarea name="keterangan_ba_bongkar_lpt" class="form-control border-0 h-100" style="resize: none;"
                                                            placeholder="Tulis keterangan di sini...">{{ old('keterangan_ba_bongkar_lpt', $bongkar->keterangan_ba_bongkar_lpt) }}</textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="container mt-4">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="lokasi_lpp_ba_bongkar"
                                                                value="{{ old('lokasi_lpp_ba_bongkar', $bongkar->lokasi_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="tanggal_pengawasan_lpp_ba_bongkar"
                                                                value="{{ old('tanggal_pengawasan_lpp_ba_bongkar', $bongkar->tanggal_pengawasan_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="time"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="waktu_pengawasan_lpp_ba_bongkar"
                                                                value="{{ old('waktu_pengawasan_lpp_ba_bongkar', $bongkar->waktu_pengawasan_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="nama_sarkut_lpp_ba_bongkar"
                                                                value="{{ old('nama_sarkut_lpp_ba_bongkar', $bongkar->nama_sarkut_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('no_flight_lpp_ba_bongkar', $bongkar->no_flight_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="nama_pengangkut_lpp_ba_bongkar"
                                                                value="{{ old('nama_pengangkut_lpp_ba_bongkar', $bongkar->nama_pengangkut_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="pelabuhan_asal_lpp_ba_bongkar"
                                                                value="{{ old('pelabuhan_asal_lpp_ba_bongkar', $bongkar->pelabuhan_asal_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="date"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="tanggal_kedatangan_lpp_ba_bongkar"
                                                                value="{{ old('tanggal_kedatangan_lpp_ba_bongkar', $bongkar->tanggal_kedatangan_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2 align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <input type="text"
                                                                class="form-control form-control-sm border-0 border-bottom border-dark"
                                                                name="nomor_tanggal_bc_lpp_ba_bongkar"
                                                                value="{{ old('nomor_tanggal_bc_lpp_ba_bongkar', $bongkar->nomor_tanggal_bc_lpp_ba_bongkar) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-6 text-center">
                                                        ...
                                                        <p class="mb-0">NIP : ................................</p>
                                                        <div class="mt-3">
                                                            <label for="pejabat_mengawasi_bongkar"
                                                                class="form-label">Pilih Pejabat</label>
                                                            <select class="form-control form-select select2"
                                                                name="pejabat_mengawasi_bongkar"
                                                                id="pejabat_mengawasi_bongkar">
                                                                <option value="" disabled
                                                                    {{ old('pejabat_mengawasi_bongkar', $bongkar->pejabat_mengawasi_bongkar) ? '' : 'selected' }}>
                                                                    - Pilih Pejabat -
                                                                </option>
                                                                @foreach ($users as $user)
                                                                    <option value="{{ $user->id_admin }}"
                                                                        {{ old('pejabat_mengawasi_bongkar', $bongkar->pejabat_mengawasi_bongkar) == $user->id_admin ? 'selected' : '' }}>
                                                                        {{ $user->name }} | {{ $user->jabatan }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
             ...
             if (idBaBongkarInput) {
                 ...
                 idBaBongkarInput.value = "{{ $bongkar->id_ba_bongkar }}"; // Pastikan ini di-set dengan benar
             }

             const idBaBongkar = "{{ $bongkar->id_ba_bongkar }}"; 
           ...
           // const idBaBongkar = idBaBongkarInput ? idBaBongkarInput.value : ''; loadData(idBaBongkar);
        });
