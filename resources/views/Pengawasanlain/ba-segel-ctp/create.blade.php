@extends('layouts.vertical', ['title' => 'Rekam Berita Acara Segel CTP'])
...
@section('content')
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="id_ba_segel_ctp" name="id_ba_segel_ctp" value="">
                                                ...
                                                <div class="mb-3 row align-items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('no_ba_segel_ctp', $no_ref->no_ba_segel_ctp) }}"
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="container">
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('nama_saksi_ctp', $sbpData->nama_saksi) }}"
                                                                                name="nama_saksi_ctp"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('alamat_saksi_ctp', $sbpData->alamat_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('pekerjaan_saksi_ctp', $sbpData->pekerjaan_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('jenis_identitas_saksi_ctp', $sbpData->jenis_iden_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('no_identitas_saksi_ctp', $sbpData->no_identitas_saksi) }}"
    ...
    <script>
        function generateUniqueID() {
            ...
            return `id_ba_segel_ctp_${timestamp}_${randomNum}`;
        }

        document.getElementById('id_ba_segel_ctp').value = generateUniqueID();
    </script>
@endsection
