@extends('layouts.vertical', ['title' => 'Edit Berita Acara Segel CTP'])
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('ba-segel-ctp.update', ['ba_segel_ctp' => $segelctp->id]) }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="tabs-container" id="tabs-container">
                                        <ul class="nav nav-pills nav-justified flex-nowrap " style="white-space: nowrap;"
                                            role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="navtabs2-ba-segel-ctp-tab"
                                                    data-bs-toggle="tab" href="#navtabs2-ba-segel-ctp" role="tab"
                                                    aria-controls="navtabs2-ba-segel-ctp" aria-selected="true">
                                                    <span class="d-block d-sm-none">(BA SEGEL CTP)</span>
                                                    <span class="d-none d-sm-block">BERITA ACARA SEGEL CTP</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="tab-pane active" id="navtabs2-ba-segel-ctp" role="tabpanel">
                                            <div class="container mt-4">
                                                ...
                                                <div class="mb-3 row align-items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('no_ba_segel_ctp', $segelctp->no_ba_segel_ctp) }}"
                                                            name="no_ba_segel_ctp" readonly>
                                                        <span class="input-group-text">/SGL/KPU.02/BD.06/</span>
                                                        <input type="date" class="form-control" name="tgl_ba_segel_ctp"
                                                            value="{{ old('tgl_ba_segel_ctp', $segelctp->tgl_ba_segel_ctp) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card p-4">
                                                    <p class="fw-bold">
                                                        ...
                                                        Telah Melakukan Segel CTP atas:
                                                    </p>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="container">
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="jenis_segel_ctp"
                                                                                value="{{ old('jenis_segel_ctp', $segelctp->jenis_segel_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="number" class="form-control"
                                                                                name="banyak_segel_ctp"
                                                                                value="{{ old('banyak_segel_ctp', $segelctp->banyak_segel_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="nomor_segel_ctp"
                                                                                value="{{ old('nomor_segel_ctp', $segelctp->nomor_segel_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="penempatan_lokasi_ctp"
                                                                                value="{{ old('penempatan_lokasi_ctp', $segelctp->penempatan_lokasi_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('nama_saksi_ctp', $segelctp->nama_saksi_ctp) }}"
                                                                                name="nama_saksi_ctp"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="alamat_saksi_ctp"
                                                                                value="{{ old('alamat_saksi_ctp', $segelctp->alamat_saksi_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="pekerjaan_saksi_ctp"
                                                                                value="{{ old('pekerjaan_saksi_ctp', $segelctp->pekerjaan_saksi_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="jenis_identitas_saksi_ctp"
                                                                                value="{{ old('jenis_identitas_saksi_ctp', $segelctp->jenis_identitas_saksi_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                name="no_identitas_saksi_ctp"
                                                                                value="{{ old('no_identitas_saksi_ctp', $segelctp->no_identitas_saksi_ctp) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat
                                                                            pertama yang melakukan Segel CTP</label>
                                                                        <div class="col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                                class="form-control form-select select2"
                                                                                name="pejabat_pertama_ctp">
                                                                                <option value="" disabled>- Pilih -
                                                                                </option>
                                                                                @foreach ($users as $user)
                                                                                    <option value="{{ $user->id_admin }}"
                                                                                        {{ old('pejabat_pertama_ctp', $segelctp->pejabat_pertama_ctp) == $user->id_admin ? 'selected' : '' }}>
                                                                                        {{ $user->name }} |
                                                                                        {{ $user->jabatan }}
                                                                                    </option>
                                                                                @endforeach
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat
                                                                            kedua yang melakukan Segel CTP</label>
                                                                        <div class="col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                                class="form-control form-select select2"
                                                                                name="pejabat_kedua_ctp">
                                                                                <option value="" disabled>- Pilih -
                                                                                </option>
                                                                                @foreach ($users as $user)
                                                                                    <option value="{{ $user->id_admin }}"
                                                                                        {{ old('pejabat_kedua_ctp', $segelctp->pejabat_kedua_ctp) == $user->id_admin ? 'selected' : '' }}>
                                                                                        {{ $user->name }} |
                                                                                        {{ $user->jabatan }}
                                                                                    </option>
                                                                                @endforeach
