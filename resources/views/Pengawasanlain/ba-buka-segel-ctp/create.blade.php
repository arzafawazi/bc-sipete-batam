...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('ba-buka-segel-ctp.store') }}" method="POST">
            @csrf
            <div class="card mb-3 mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i data-feather="book" style="width: 20px; height: 20px;" class="me-1"></i>
                        Form Rekam Data B.A Buka Segel CTP
                    </h5>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="id_ba_buka_segel_ctp" name="id_ba_buka_segel_ctp" value="">
                                                ...
                                                <div class="mb-3 row align-items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('no_ba_buka_segel_ctp', $no_ref->no_ba_buka_segel_ctp) }}"
                                                            name="no_ba_buka_segel_ctp" readonly>
                                                        <span class="input-group-text">/SGL/KPU.02/BD.06/</span>
                                                        <input type="date" class="form-control" name="tgl_ba_buka_segel_ctp">
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="container">
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('nama_saksi_buka_ctp', $sbpData->nama_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('alamat_saksi_buka_ctp', $sbpData->alamat_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('pekerjaan_saksi_buka_ctp', $sbpData->pekerjaan_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('jenis_identitas_saksi_buka_ctp', $sbpData->jenis_iden_saksi) }}"
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{ old('no_identitas_saksi_buka_ctp', $sbpData->no_identitas_saksi) }}"
    ...
    <script>
        function generateUniqueID() {
            ...
            return `id_ba_buka_segel_ctp_${timestamp}_${randomNum}`;
        }

        document.getElementById('id_ba_buka_segel_ctp').value = generateUniqueID();
    </script>
@endsection
