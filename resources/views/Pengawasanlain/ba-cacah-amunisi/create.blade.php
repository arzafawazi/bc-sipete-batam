 @extends('layouts.vertical', ['title' => 'Rekam Berita Acara Cacah Amunisi'])
 ...
 @section('content')
     <div class="container-fluid">
         <form action="{{ route('ba-cacah-amunisi.store') }}" method="POST">
             @csrf
             <div class="card mb-3 mt-4">
                 <div class="card-header d-flex justify-content-between align-items-center">
                     <h5 class="card-title mb-0">
                         <i data-feather="book" style="width: 20px; height: 20px;" class="me-1"></i>
                         Form Rekam Data Berita Acara Cacah Amunisi
                     </h5>
                             ...
                             <div class="card">
                                 <div class="card-body">
                                     ...
                                     <div class="tab-content p-3 text-muted">
                                         <input type="hidden" id="id_ba_cacah_amunisi" name="id_ba_cacah_amunisi"
                                             value="">
                                                 ...
                                                 <div class="mb-3 row align-items-center">
                                                     <div class="input-group flex-wrap">
                                                         ...
                                                         <input type="text" class="form-control"
                                                             value="{{ old('no_ba_cacah_amunisi', $no_ref->no_ba_cacah_amunisi) }}"
                                                         ...
                                                         <div class="row">
                                                             <div class="col-lg-12">
                                                                 <div class="container-fluid px-0 px-sm-3">
                                                                     ...
                                                                     <div class="fw-bold text-center">
                                                                         <textarea class="form-control" name="memberikan_izin senjata" rows="3" placeholder="memberikan izin....."></textarea>
                                                                     </div>
                                                                     ...
                                                                     <div class="fw-bold text-center">
                                                                         <textarea class="form-control" placeholder="ditandatangani di" name="ditandatangani_cacah_amunisi" rows="3"></textarea>
                                                                     </div>
                                         ...
                                         <div class="card-footer d-flex justify-content-end">
                                             <button type="submit" class="btn btn-success btn-sm me-2">
                                                 <i data-feather="save"></i> Simpan Data Ba Cacah Amunisi
                                             </button>
                                         </div>
                                     </div>
                                 </div>
     ...
     <script>
         function generateUniqueID() {
             ...
             return `id_ba_cacah_amunisi${timestamp}_${randomNum}`;
         }

         document.getElementById('id_ba_cacah_amunisi').value = generateUniqueID();
     </script>
 @endsection
