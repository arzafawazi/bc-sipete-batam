@extends('layouts.vertical', ['title' => 'Rekam Berita Acara Pembukaan Segel'])
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('ba-pembukaan-segel.store') }}" method="POST">
            @csrf
            <div class="card mb-3 mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i data-feather="book" style="width: 20px; height: 20px;" class="me-1"></i>
                        Form Rekam Data B.A Pembukaan Segel
                    </h5>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="id_ba_pembukaan_segel" name="id_ba_pembukaan_segel"
                                        value="">
                                            ...
                                            <div class="container mt-4">
                                                ...
                                                <div class="mb-3 row align-items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control" name="tgl_ba_buka_segel" >
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="container">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <br>
                                                                        <strong>Pembukaan segel disaksikan oleh pengangkut/pemilik/ atau kuasanya/ketua lingkungan/dll*:</strong>
                                                                    </p>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text"
                                                                                class="form-control"
                                                                                value="{{ old('nama_saksi_ba_buka_segel', $sbpData->nama_saksi) }}" name="nama_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text"
                                                                                class="form-control"
                                                                                value="{{ old('alamat_saksi_ba_buka_segel', $sbpData->alamat_saksi) }}" name="alamat_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                     ...
                                                                     <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text"
                                                                                class="form-control"
                                                                                value="{{ old('pekerjaan_saksi_ba_buka_segel', $sbpData->pekerjaan_saksi) }}" name="pekerjaan_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                     ...
                                                                     <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text"
                                                                                class="form-control"
                                                                                value="{{ old('jenis_iden_saksi_ba_buka_segel', $sbpData->jenis_iden_saksi) }}" name="jenis_iden_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>

                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Nomor Identitas</label>
                                                                        <div class=" col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <input type="text"
                                                                                class="form-control"
                                                                                value="{{ old('nomor_iden_saksi_ba_buka_segel', $sbpData->no_identitas_saksi) }}" name="nomor_iden_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat pertama yang melakukan pembukaan segel</label>
                                                                        <div class=" col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat kedua yang melakukan pembukaan segel</label>
                                                                        <div class=" col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                                class="form-control form-select select2"
    ...
    <script>
        function generateUniqueID() {
            ...
            return `id_ba_pembukaan_segel_${timestamp}_${randomNum}`;
        }

        document.getElementById('id_ba_pembukaan_segel').value = generateUniqueID();
    </script>
@endsection
