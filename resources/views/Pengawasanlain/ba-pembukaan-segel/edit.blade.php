@extends('layouts.vertical', ['title' => 'Edit Berita Acara Pembukaan Segel'])
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('ba-pembukaan-segel.update', ['ba_pembukaan_segel' => $bukasegel->id]) }}" method="POST"
            enctype="multipart/form-data">
            <div class="card mb-3 mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i data-feather="book" style="width: 20px; height: 20px;" class="me-1"></i>
                        Form Edit Data B.A Pembukaan Segel
                    </h5>
                                ...
                                <div class="card-body">
                                    <div class="tabs-container" id="tabs-container">
                                        <ul class="nav nav-pills nav-justified flex-nowrap " style="white-space: nowrap;"
                                            role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="navtabs2-ba-buka-segel-tab"
                                                    data-bs-toggle="tab" href="#navtabs2-ba-buka-segel" role="tab"
                                                    aria-controls="navtabs2-ba-buka-segel" aria-selected="true">
                                                    <span class="d-block d-sm-none">(BA BUKA SEGEL)</span>
                                                    <span class="d-none d-sm-block">BERITA ACARA PEMBUKAAN SEGEL</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="tab-pane active" id="navtabs2-ba-buka-segel" role="tabpanel">
                                            <div class="container mt-4">
                                                ...
                                                <div class="mb-3 row align-items-center">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('no_ba_buka_segel', $bukasegel->no_ba_buka_segel) }}"
                                                            name="no_ba_buka_segel" readonly>
                                                        <span class="input-group-text">/Buka Segel/KPU.206/</span>
                                                        <input type="date" class="form-control" name="tgl_ba_buka_segel" value="{{ old('tgl_ba_buka_segel', $bukasegel->tgl_ba_buka_segel) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card p-4">
                                                    <p class="fw-bold">
                                                        ...
                                                        Telah Melakukan Pembukaan Segel atas:
                                                    </p>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="container">
                                                                    ...
                                                                    <h5 class="fw-bold">Membuka</h5>

                                                                    <p>
                                                                        Membuka, jenis tanda pengaman yang digunakan adalah
                                                                        <strong>{{ old('jenis_segel_ba_segel', $sbpData->jenis_segel_ba_segel) }}</strong>,
                                                                        sebanyak
                                                                        <strong>{{ old('jumlah_segel_ba_segel', $sbpData->jumlah_segel_ba_segel) }}</strong>
                                                                        buah, dengan nomor
                                                                        <strong>{{ old('nomor_segel_ba_segel', $sbpData->nomor_segel_ba_segel) }}</strong>,
                                                                        yang diletakkan pada
                                                                        <strong>{{ old('peletakan_segel_ba_segel', $sbpData->peletakan_segel_ba_segel) }}</strong>.
                                                                        <br>
                                                                        <strong>Pembukaan segel disaksikan oleh
                                                                            pengangkut/pemilik/ atau kuasanya/ketua
                                                                            lingkungan/dll*:</strong>
                                                                    </p>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('nama_saksi_ba_buka_segel', $bukasegel->nama_saksi_ba_buka_segel) }}"
                                                                                name="nama_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('alamat_saksi_ba_buka_segel', $bukasegel->alamat_saksi_ba_buka_segel) }}"
                                                                                name="alamat_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('pekerjaan_saksi_ba_buka_segel', $bukasegel->pekerjaan_saksi_ba_buka_segel) }}"
                                                                                name="pekerjaan_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('jenis_iden_saksi_ba_buka_segel', $bukasegel->jenis_iden_saksi_ba_buka_segel) }}"
                                                                                name="jenis_iden_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="text" class="form-control"
                                                                                value="{{ old('nomor_iden_saksi_ba_buka_segel', $bukasegel->nomor_iden_saksi_ba_buka_segel) }}"
                                                                                name="nomor_iden_saksi_ba_buka_segel">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat
                                                                            pertama yang melakukan pembukaan segel</label>
                                                                        <div class="col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                                class="form-control form-select select2"
                                                                                name="pejabat_pertama_buka_segel">
                                                                                <option value="" disabled
                                                                                    {{ old('pejabat_pertama_buka_segel', $bukasegel->pejabat_pertama_buka_segel) ? '' : 'selected' }}>
                                                                                    - Pilih -</option>
                                                                                @foreach ($users as $user)
                                                                                    <option value="{{ $user->id_admin }}"
                                                                                        {{ old('pejabat_pertama_buka_segel', $bukasegel->pejabat_pertama_buka_segel) == $user->id_admin ? 'selected' : '' }}>
                                                                                        {{ $user->name }} |
                                                                                        {{ $user->jabatan }}
                                                                                    </option>
                                                                                @endforeach
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        <label class="col-md-3 col-form-label">Pejabat
                                                                            kedua yang melakukan pembukaan segel</label>
                                                                        <div class="col-md-1 text-center mt-1">:</div>
                                                                        <div class="col-md-8">
                                                                            <select
                                                                                class="form-control form-select select2"
                                                                                name="pejabat_kedua_buka_segel">
                                                                                <option value="" disabled
                                                                                    {{ old('pejabat_kedua_buka_segel', $bukasegel->pejabat_kedua_buka_segel) ? '' : 'selected' }}>
                                                                                    - Pilih -</option>
                                                                                @foreach ($users as $user)
                                                                                    <option value="{{ $user->id_admin }}"
                                                                                        {{ old('pejabat_kedua_buka_segel', $bukasegel->pejabat_kedua_buka_segel) == $user->id_admin ? 'selected' : '' }}>
                                                                                        {{ $user->name }} |
                                                                                        {{ $user->jabatan }}
                                                                                    </option>
                                                                                @endforeach
                                        ...
                                        <div class="card-footer d-flex justify-content-end">
                                            <button type="submit" class="btn btn-success btn-sm me-2">
                                                <i data-feather="save"></i> Simpan Data Berita Acara Pembukaan Segel
                                            </button>
                                        </div>
