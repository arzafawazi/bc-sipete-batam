@extends('layouts.vertical', ['title' => 'Laporan Pra-penindakan NPP'])
...
<div class="container-fluid">
    ...
    <div class="card mb-3 mt-4">
        <div class="card-header">
            <h5 class="card-title mb-0">PRA-PENINDAKAN NPP</h5>
        </div>
        <div class="card-body">
            <form method="GET" >
                <div class="row">
    ...
    <button type="button" class="btn btn-success btn-sm">
        <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Data Laporan Pra-penindakan NPP
    </button>
</a>
