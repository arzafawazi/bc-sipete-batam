@extends('layouts.vertical', ['title' => 'Laporan Pasca Penindakan'])
...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-success btn-sm">
        <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Data Laporan Pasca Penindakan
    </button>
</a>
