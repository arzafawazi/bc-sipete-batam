  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3 mt-4">
      <div class="card-header">
        <h5 class="card-title mb-0">DAFTAR DOKUMEN PENINDAKAN</h5>
      </div>
      <div class="card-body">
        <form method="GET">
          <div class="row">
            ...
            <table id="fixed-header-datatable" class="table table-hover align-middle border-separate" style="border-spacing: 0 8px;">
              <thead>
                <tr class="bg-light">
                  ...
                  <th class="px-3 text-center py-3" style="width: 15%">No Penindakan</th>
                  <th class="px-3 text-center py-3" style="width: 15%">Tanggal Penindakan</th>
                  ...
                  <tr class="shadow-sm">
                    ...
                    <td>
                      ...
                      <div class="d-flex gap-1 justify-content-center">
                        ...
                        <form action="{{ route('penindakan.destroy', $penindakan->id) }}" method="POST" class="d-inline delete-form">
                          @csrf
                          @method('DELETE')
