@extends('layouts.vertical', ['title' => 'Form Edit Sbp'])
    ...
    <div class="card mb-3 mt-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">
          ...
          Form Edit Surat Bukti Penindakan (SBP)
        </h5>
        <!-- Tombol Kembali -->
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control bg-primary text-white" name="no_print" id="no_print" value="" readonly>
                </div>
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control bg-primary text-white" name="tgl_print" value="" readonly>
                </div>
            ...
            <option value="CARGO">Barang Kiriman/Cargo</option>
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <select class="form-control" id="skema_penindakan" name="skema_penindakan" required>
                    <option value="">- Pilih -</option>
                      ...
                      <div id="flush-collapse1" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body bg-light">
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                              <select id="ba_tegah" class="form-select" name="ba_tegah" onchange="toggleBA(this, 'no_ba_tegah', '{{ old('no_ba_tegah', $penindakans->no_ba_tegah) }}')">
                                <option value="TIDAK">TIDAK</option>
                                <option value="YA">YA</option>
                              </select>
                            </div>
                          ...
                          <div class="row mb-3 form-group">
                            ...
                            <div class="col-sm-8">
                              <select id="bast_barang" class="form-select" name="bast_barang" onchange="toggleBA(this, 'no_ba_bast_barang', '{{ old('no_ba_bast_barang', $penindakans->no_ba_bast_barang) }}')">
                                <option value="TIDAK">TIDAK</option>
                                <option value="YA">YA</option>
                              </select>
                            </div>
                      ...
                      <div id="flush-collapse2" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body bg-light">
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                              <select id="ba_riksa" class="form-select" name="ba_riksa" onchange="toggleBA(this, 'no_ba_riksa', '{{ old('no_ba_riksa', $penindakans->no_ba_riksa) }}')">
                                <option value="TIDAK">TIDAK</option>
                                <option value="YA">YA</option>
                              </select>
                            </div>
                      ...
                      <div id="flush-collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body bg-light">
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                              <select id="ba_segel" class="form-select" name="ba_segel" onchange="toggleBA(this, 'no_ba_segel', '{{ old('no_ba_segel', $penindakans->no_ba_segel) }}')">
                                <option value="TIDAK">TIDAK</option>
                                <option value="YA">YA</option>
                              </select>
                            </div>
...
<div class="row">
  ...
  {{-- <script>
    function toggleBA(select) {
        ...
        const originalValue = "{{ old('no_ba_tegah', $penindakans->no_ba_tegah) }}"; // Value asli
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      toggleBA(document.getElementById("ba_tegah"), 'no_ba_tegah', '{{ old('no_ba_tegah', $penindakans->no_ba_tegah) }}');
      toggleBA(document.getElementById("ba_riksa"), 'no_ba_riksa', '{{ old('no_ba_riksa', $penindakans->no_ba_riksa) }}');
      toggleBA(document.getElementById("ba_segel"), 'no_ba_segel', '{{ old('no_ba_segel', $penindakans->no_ba_segel) }}');
      toggleBA(document.getElementById("bast_barang"), 'no_bast_barang', '{{ old('no_bast_barang', $penindakans->no_bast_barang) }}');
    });
  </script>
@endsection
