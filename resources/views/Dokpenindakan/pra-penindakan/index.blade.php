...
@section('content')
  <div class="container-fluid">
        ...
        <form method="GET">
          <div class="row">
            ...
            <div class="col-12 d-flex justify-content-center flex-wrap gap-2">
              ...
              <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#praPenindakanInfoModal">
    ...
    <div class="modal fade" id="praPenindakanInfoModal" tabindex="-1" aria-labelledby="praPenindakanInfoModal" aria-hidden="true">
              ...
              <tbody>
                @foreach ($dokumenIntelijen as $intelijen)
                  <tr align="center">
                    ...
                    <td>
                      <button type="button" class="btn btn-primary pilih-laporan" data-nomor="{{ $intelijen->id_pengawasan }}">
                        Pilih
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr class="shadow-sm">
                    ...
                    <td>
                      <div class="d-flex gap-1 justify-content-center">
                        <a href="{{ route('pra-penindakan.edit', ['pra_penindakan' => $praPenindakan->id]) }}" class="btn btn-soft-success btn-icon btn-sm rounded-pill">
                          <i data-feather="edit" class="icon-sm"></i> Edit
                        </a>
                        <form action="{{ route('pra-penindakan.destroy', $praPenindakan->id) }}" method="POST" class="d-inline delete-form">
                          @csrf
                          @method('DELETE')
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                          <div class="modal-header border-bottom-0 pb-0">
                            <h5 class="modal-title" id="printModalLabel">Print Dokumen Pra Penindakan</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                                ...
                                <div class="col-md-4">
                                  <div class="card print-card border-primary shadow-lg">
                                    <div class="card-body text-center">
                                      ...
                                      <h6 class="card-title mb-3">Surat Laporan Informasi</h6>
                                      <a href="{{ route('laporan-informasi.print', $praPenindakan->id) }}" class="btn btn-outline-primary print-btn">Print</a>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                  <div class="card print-card border-success shadow-lg">
                                    <div class="card-body text-center">
                                      ...
                                      <a href="{{ route('surat-npi.print', $praPenindakan->id) }}" class="btn btn-outline-success print-btn">Print</a>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="card print-card border-warning shadow-lg">
                                    <div class="card-body text-center">
                                      ...
                                      <a href="{{ route('surat-lapp.print', $praPenindakan->id) }}" class="btn btn-outline-warning print-btn">Print</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="col-md-4">
                                  <div class="card print-card border-info shadow-lg">
                                    <div class="card-body text-center">
                                      ...
                                      <a href="{{ route('surat-mpp.print', $praPenindakan->id) }}" class="btn btn-outline-danger print-btn">Print</a>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="card print-card border-danger shadow-lg">
                                    <div class="card-body text-center">
                                      ...
                                      <h6 class="card-title mb-3">Surat Perintah</h6>
                                      <a href="{{ route('surat-perintah.print', $praPenindakan->id) }}" class="btn btn-outline-danger print-btn">Print</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      document.addEventListener('click', function(event) {
        if (event.target.classList.contains('pilih-laporan')) {
          ...
          let url = `/Dokpenindakan/pra-penindakan/create?id_dokumen_intelijen=${encodeURIComponent(nomorLaporan)}`;
