...
@csrf
    ...
    <div class="accordion-item">
        ...
        <div id="flush-collapseEleven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            ...
            <div class="col-lg-12 mb-3">
                    ...
                    <textarea type="text" class="form-control form-input" name="kesimpulan_lap" placeholder="Kesimpulan" row="2" ></textarea>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control bg-primary text-white" name="no_print" value="{{ old('no_print', $no_ref->no_print) }}"  readonly>
                    </div>
                    <!-- Media Informasi / Isi Informasi / Catatan -->
                    <div class="col-md-12 mb-3">
    ...
    <select class="form-control select2" id="id_pejabat_sp_1" name="id_pejabat_sp_1[]" multiple="multiple" required>
