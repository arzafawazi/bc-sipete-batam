                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select select2"
                                                    ...
                                                    <option value="" disabled
                                                        {{ old('tipe_surat_perintah_pra_penindakan', $praPenindakan->tipe_surat_perintah_pra_penindakan) == '' ? 'selected' : '' }}>
                                                        - Pilih -</option>
                                                    <option value="Surat Perintah NHI"
                                                        {{ old('tipe_surat_perintah_pra_penindakan', $praPenindakan->tipe_surat_perintah_pra_penindakan) == 'Surat Perintah NHI' ? 'selected' : '' }}>
                                                        Surat Perintah NHI</option>
                                                    <option value="Surat Perintah OC"
                                                        {{ old('tipe_surat_perintah_pra_penindakan', $praPenindakan->tipe_surat_perintah_pra_penindakan) == 'Surat Perintah OC' ? 'selected' : '' }}>
                                                        Surat Perintah OC</option>
                                                    <option value="Surat Perintah Patroli Laut"
                                                        {{ old('tipe_surat_perintah_pra_penindakan', $praPenindakan->tipe_surat_perintah_pra_penindakan) == 'Surat Perintah Patroli Laut' ? 'selected' : '' }}>
                                                        Surat Perintah Patroli Laut</option>
                                                    <option value="Surat Perintah Bulanan"
                                                        {{ old('tipe_surat_perintah_pra_penindakan', $praPenindakan->tipe_surat_perintah_pra_penindakan) == 'Surat Perintah Bulanan' ? 'selected' : '' }}>
                                                        Surat Perintah Bulanan</option>
                                                </select>
                                            </div>
