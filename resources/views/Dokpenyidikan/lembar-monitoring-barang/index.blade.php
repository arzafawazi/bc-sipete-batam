@extends('layouts.vertical', ['title' => 'Lembar Monitoring Barang'])
...
<div class="container-fluid">
    ...
    <div class="card mb-3 mt-4">
        <div class="card-header">
            <h5 class="card-title mb-0">Lembar Monitoring Barang</h5>
        </div>
        <div class="card-body">
            <form method="GET" >
                <div class="row">
    ...
    <button type="button" class="btn btn-success btn-sm">
        <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Lembar Monitoring Barang
    </button>
</a>
