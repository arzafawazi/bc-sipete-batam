                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                              <label>No. LPP</label>
                              <input type="text" class="form-control bg-primary text-white" name="no_lpp" value="{{ old('no_lpp', $penyidikan->no_lpp) }}" readonly>
                            </div>

                            <div class="col-md-6 mb-3">
                              <label>Tgl. LPP</label>
                              <input type="date" class="form-control bg-primary text-white" name="tgl_lpp" value="{{ old('tgl_lpp', $penyidikan->tgl_lpp) }}">
                            </div>

                            <div class="col-lg-12 mb-3">
                              <label>Pejabat 1 Penyidikan</label>
                              <select class=" form-select select2" name="id_1_pejabat_penyidik">
                                <option value="" selected disabled>- Pilih -</option>
                                @foreach ($users as $user)
                                  <option value="{{ $user->id_admin }}" {{ old('id_1_pejabat_penyidik', $penyidikan->id_1_pejabat_penyidik) == $user->id_admin ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-12 mb-3">
                              ...
                              <select class="form-control form-select select2" name="id_2_pejabat_penyidik">
                                <option value="" selected disabled>- Pilih -</option>
                                @foreach ($users as $user)
                                  <option value="{{ $user->id_admin }}" {{ old('id_2_pejabat_penyidik', $penyidikan->id_2_pejabat_penyidik) == $user->id_admin ? 'selected' : '' }}>
                                    {{ $user->name }} | {{ $user->jabatan }}
                                  </option>
                                @endforeach
                              </select>
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Diisi asal perkara (nama unit/instansi yang menyerahkan perkara)" name="asal_perkara_lpp">{{ old('asal_perkara_lpp', $penyidikan->asal_perkara_lpp) }}</textarea>
                          </div>

                          <div class="col-md-12 mb-3">
                            <label>Jenis Penindakan</label>
                            <textarea class="form-control" rows="3" placeholder="Diisi jenis penindakan (penghentian sarana pengangkut/ pemeriksaan barang/penyegelan/Penegahan/penangkapan)." name="jenis_penindakan_lpp">{{ old('jenis_penindakan_lpp', $penyidikan->jenis_penindakan_lpp) }}</textarea>
                          </div>

                          <div class="col-md-12 mb-3">
                            <label>Jenis Perkara</label>
                            <textarea class="form-control" rows="3" placeholder="Diisi jenis perkara (impor umum/impor fasilitas/impor BKC/ cukai HT/cukai EA/cukai MMEA/ekspor/pengangkutan barang tertentu/ barang penumpang)." name="jenis_perkara_lpp">{{ old('jenis_perkara_lpp', $penyidikan->jenis_perkara_lpp) }}</textarea>
                          </div>
                          ...
                          <div class="col-md-12 mb-3">
                            ...
                            <select name="status_pelanggaran_lpp" class="form-control form-select select2">
                              <option value="" selected disabled>- Pilih -</option>
                              <option value="Tertangkap Tangan" {{ old('status_pelanggaran_lpp', $penyidikan->status_pelanggaran_lpp) == 'Tertangkap Tangan' ? 'selected' : '' }}>Tertangkap Tangan</option>
                              <option value="Tidak Tertangkap Tangan" {{ old('status_pelanggaran_lpp', $penyidikan->status_pelanggaran_lpp) == 'Tidak Tertangkap Tangan' ? 'selected' : '' }}>Tidak Tertangkap Tangan</option>
                            </select>
                          </div>
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                              <div class="accordion-body bg-light">
                                ...
                                <div class="col-md-12 mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Komoditi" name="komoditi_lpp" value="{{ old('komoditi_lpp', $penyidikan->komoditi_lpp) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>Merk Barang</label>
                                  <input type="text" class="form-control" placeholder="Merek Barang" name="merek_barang_lpf" value="{{ old('merek_barang_lpf', $penyidikan->merek_barang_lpf) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>Kondisi Barang</label>
                                  <input type="text" class="form-control" placeholder="Kondisi Barang" name="kondisi_barang_lpf" value="{{ old('kondisi_barang_lpf', $penyidikan->kondisi_barang_lpf) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>Tipe Barang</label>
                                  <input type="text" class="form-control" placeholder="Tipe Barang" name="tipe_barang_lpf" value="{{ old('tipe_barang_lpf', $penyidikan->tipe_barang_lpf) }}">
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Kantor Pendaftaran Dokumen" name="kantor_pendaftaran_lpf" value="{{ old('kantor_pendaftaran_lpf', $penyidikan->kantor_pendaftaran_lpf) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>Jumlah Koli / jenis koli</label>
                                  <input type="text" class="form-control" placeholder="Jumlah Koli / jenis koli" name="jumlah_koli_lpp" value="{{ old('jumlah_koli_lpp', $penyidikan->jumlah_koli_lpp) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>No Container / ukuran</label>
                                  <input type="text" class="form-control" placeholder="No Container / ukuran" name="no_container_lpp" value="{{ old('no_container_lpp', $penyidikan->no_container_lpp) }}">
                                </div>

                                <div class="col-md-12 mb-3">
                                  <label>Keterangan Uraian Barang</label>
                                  <input type="text" class="form-control" placeholder="Keterangan Uraian" name="ket_uraian_bar_lpp" value="{{ old('ket_uraian_bar_lpp', $penyidikan->ket_uraian_bar_lpp) }}">
                                </div>
                    ...
                    <div class="tab-pane fade" id="lpf" role="tabpanel" aria-labelledby="lpf-tab">
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label>No. LPF</label>
                            <input type="text" class="form-control bg-primary text-white" name="no_lpf" value="{{ old('no_lpf', $penyidikan->no_lpf) }}" readonly>
                          </div>
                                ...
                                <div class="accordion-body bg-light">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control bg-primary text-white" name="no_split" value="{{ old('no_split', $penyidikan->no_split) }}" readonly>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                      <label>Tgl. SPLIT</label>
                                      <input type="date" class="form-control bg-primary text-white" placeholder="yyyy-mm-dd" name="tgl_split" value="{{ old('tgl_split', $penyidikan->tgl_split) }}">
                                    </div>
                                  </div>
                          ...
                          <div id="flush-collapseMain" class="accordion-collapse collapse" data-bs-parent="#mainAccordion">
                            <div class="accordion-body bg-light">
                              ...
                              <div class="col-md-12 mb-3">
                                ...
                                <input type="date" class="form-control bg-primary text-white" value="{{ old('tgl_baw', $penyidikan->tgl_baw) }}" placeholder="yyyy-mm-dd" name="tgl_baw">
                              </div>
                              ...
                              <div class="accordion-body bg-light">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control bg-primary text-white" placeholder="yyyy-mm-dd" name="tgl_print_cacah" value="{{ old('tgl_print_cacah', $penyidikan->tgl_print_cacah) }}">
                                  </div>
                                </div>
                            ...
                            <div class="accordion-body bg-light">
                              ...
                              <div class="row">
                                <div class="col-md-6 mb-3">
                                  ...
                                  <input type="text" class="form-control bg-primary text-white" name="no_ba_cacah" value="{{ old('no_ba_cacah', $penyidikan->no_ba_cacah) }}" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label>Tgl. B.A Cacah</label>
                                  <input type="date" class="form-control bg-primary text-white" placeholder="yyyy-mm-dd" name="tgl_ba_cacah" value="{{ old('tgl_ba_cacah', $penyidikan->tgl_ba_cacah) }}">
                                </div>
                              </div>
                    ...
                    <div class="tab-pane fade" id="lhp" role="tabpanel" aria-labelledby="lhp-tab">
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label>No. LHP</label>
                            <input type="text" class="form-control bg-primary text-white" name="no_lhp_penyidikan" value="{{ old('no_lhp_penyidikan', $penyidikan->no_lhp_penyidikan) }}" readonly>
                          </div>

                          <div class="col-md-6 mb-3">
                            <label>Tgl. LHP</label>
                            <input type="date" class="form-control bg-primary text-white" placeholder="yyyy-mm-dd" name="tgl_lhp_penyidikan" value="{{ old('tgl_lhp_penyidikan', $penyidikan->tgl_lhp_penyidikan) }}">
                          </div>
                            ...
                            <div class="accordion-item">
                              ...
                              <div id="flush-collapseOnesbbv" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body bg-light">
                                  ...
                                  <div class="col-md-12 mb-3">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama" name="nama_lhp" value="{{ old('nama_lhp', $penyidikan->nama_lhp ?? '') }}">
                                  </div>

                                  <div class="col-md-12 mb-3">
                                    <label>NIK/No. Passport</label>
                                    <input type="text" class="form-control" placeholder="NIK/No. Passport" name="nik_paspor_lhp" value="{{ old('nik_paspor_lhp', $penyidikan->nik_paspor_lhp ?? '') }}">
                                  </div>

                                  <div class="col-md-12 mb-3">
                                    <label>Nomor Telepon</label>
                                    <input type="text" class="form-control" placeholder="Nomor Telepon" name="no_telp" value="{{ old('no_telp', $penyidikan->no_telp ?? '') }}">
                                  </div>
                                  ...
                                  <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select form-input select2" name="jk_lhp">
                                      ...
                                      <option value="Laki-Laki" @if (old('jk_lhp', $penyidikan->jk_lhp ?? '') == 'Laki-Laki') selected @endif>Laki-Laki</option>
                                      <option value="Perempuan" @if (old('jk_lhp', $penyidikan->jk_lhp ?? '') == 'Perempuan') selected @endif>Perempuan</option>
                                    </select>
                                  </div>
                        ...
                        <div class="col-md-12 mb-3">
                          ...
                          <textarea class="form-control" rows="3" placeholder="Alternatif Penyelesaian Perkara" name="penyelesaian_perkara_lhp">{{ old('penyelesaian_perkara_lhp', $penyidikan->penyelesaian_perkara_lhp ?? '') }}</textarea>
                        </div>
