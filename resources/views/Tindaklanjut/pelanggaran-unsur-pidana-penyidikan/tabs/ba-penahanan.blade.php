         ...
         <div class="col-lg-12">
           <div class="container-fluid px-0 px-sm-3">
             ...
             <p class="text-black">
                ...
                <br>---------------------------------------------------------------------------------------
                <br>------------------------------------- .............(7)............... ----------------------------------------
                <br>Pangkat / Gol : ........(8)........, Jabatan : Penyidik ........(9)........., bersama-sama dengan:
                <br>---------------------------------------------------------------------------------------
                <br>1. ...........(10)............/.........(11)......../Penyidik.............(12)............---------------------------------
                <br>2. ...........(13)............/.........(14)......../Penyidik .............(15)........... --------------------------------
             ...
             <div class="mb-3 row">
              ...
              <div class="mb-3 row">
               <label class="col-md-3 col-sm-12 col-form-label">Alamat Sesuai Identitas</label>
               <div class="col-md-1 col-sm-1 text-center mt-1 d-none d-sm-block">:</div>
               <div class="col-md-8 col-sm-11">
                 <input type="text" class="form-control">
               </div>
             ...
             <div class="mb-3 row">
               <label class="col-md-3 col-sm-12 col-form-label">Alamat tempat tinggal</label>
               <div class="col-md-1 col-sm-1 text-center mt-1 d-none d-sm-block">:</div>
               <div class="col-md-8 col-sm-11">
                 <input type="text" class="form-control">
               </div>
            ...
            <br><br>
            Keadaan kesehatan/fisik dan mental Tersangka sebelum dimasukkan ke dalam ruangan tahanan sehat jasmani dan rohani.
            <br><br>
            ------------------ Sidik jari : .................(34)...................
            <br>------------------ Pemotretan : .................(35)...................
            <br>------------------ Barang-barang titipan berupa : .................(36)...................
            <br><br>
            Demikian Berita Acara Penahanan ini dibuat dengan sebenarnya atas kekuatan sumpah jabatan, kemudian ditutup dan ditandatangani di .......(37)....... pada hari dan tanggal tersebut di atas.
        </p>



             <div class="mb-3 row">
              <label class="col-md-3 col-sm-12 col-form-label fw-bold text-md-start">Penyidik Yang Melakukan Pengambilan Sidik Jari</label>
              <div class="col-md-1 col-sm-1 text-center mt-1 d-none d-sm-block">:</div>
              <div class="col-md-8 col-sm-11">
                <select class="form-control form-select select2" name="pejabat_sidik">
                  <option value="" selected disabled>- Pilih -</option>
                  @foreach ($users as $user)
                    <option value="{{ $user->id_admin }}" {{ old('pejabat_sidik', isset($unsurpenyidikan) ? $unsurpenyidikan->pejabat_sidik : '') == $user->id_admin ? 'selected' : '' }}>
