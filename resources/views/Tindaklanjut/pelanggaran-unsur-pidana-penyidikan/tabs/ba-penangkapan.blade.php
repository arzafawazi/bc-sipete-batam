 <div class="container-fluid mt-4">
     ...
     <h5 class="fw-bold text-center text-black"><u>BERITA ACARA PENANGKAPAN </u></h5>
                 ...
                 <div class="col-lg-12">
                     <div class="container-fluid px-0 px-sm-3">
                         ...
                         <ol class="ps-3 text-black" start="1" style="line-height: 1.5;">
                             <li class="mb-1 ps-1">
                                 Laporan Kejadian Tindak Pidana nomor: LK- ...............(14)................. tanggal
                                 ...........(15)............
                                 <hr class="my-1">
                             </li>
                             <li class="mb-1 ps-1">
                                 Surat Perintah Tugas Penyidikan nomor: SPTP- ................(16).................
                                 tanggal ...........(17).............
                                 <hr class="my-1">
                             </li>
                             <li class="mb-1 ps-1">
                                 Surat Perintah Penangkapan nomor: SPP- ................(18).................. tanggal
                                 ………(19)…..…….
                                 <hr class="my-1">
                             </li>
                         </ol>
                         ...
                         <p class="text-black"><b>Data Tersangka Penangkapan</b></p>
                         @foreach ($tersangkaData as $index => $tersangka)
                             @php
                                 $BaTangkapTersangka = $BaPenangkapanTersangka[$index] ?? null;
                             @endphp
                             <hr>

                             <div class="mb-3 row">
                                 <label class="col-md-3 col-sm-12 col-form-label">Waktu BA Penangkapan</label>
                                 <div class="col-md-1 text-center mt-1 d-none d-sm-block">:</div>
                                 <div class="col-md-8 col-sm-11">
                                     <input type="text" class="form-control datetime-datepicker"
                                         name="waktu_ba_penangkapan[]"
                                         value="{{ old('waktu_ba_penangkapan.' . $index, $BaTangkapTersangka['waktu_penangkapan'] ?? '') }}">
                                 </div>
                             </div>
                             ...
                             <div class="mb-3 row">
                                 ...
                                 <div class="col-md-8 col-sm-11">
                                     <select class="form-control py-1 form-select select2"
                                         name="pejabat_pertama[]">
                                         <option value="" disabled
                                             {{ old('pejabat_pertama.' . $index, $BaTangkapTersangka['pejabat_pertama'] ?? '') == '' ? 'selected' : '' }}>
                                             - Pilih -</option>
                                         @foreach ($users as $user)
                                             <option value="{{ $user->id_admin }}"
                                                 {{ old('pejabat_pertama.' . $index, $BaTangkapTersangka['pejabat_pertama'] ?? '') == $user->id_admin ? 'selected' : '' }}>
                             ...
                             <div class="mb-3 row">
                                 ...
                                 <div class="col-md-1 text-center mt-1 d-none d-sm-block">:</div>
                                 <div class="col-md-8 col-sm-11">
                                     <select class="form-control py-1 form-select select2" name="pejabat_kedua[]">
                                         <option value="" disabled
                                             {{ old('pejabat_kedua.' . $index, $BaTangkapTersangka['pejabat_kedua'] ?? '') == '' ? 'selected' : '' }}>
                                             - Pilih -</option>
                                         @foreach ($users as $user)
                                             <option value="{{ $user->id_admin }}"
                                                 {{ old('pejabat_kedua.' . $index, $BaTangkapTersangka['pejabat_kedua'] ?? '') == $user->id_admin ? 'selected' : '' }}>
                                                 {{ $user->name }} | {{ $user->pangkat }} | {{ $user->jabatan }}
                                             </option>
                                         @endforeach
                                     </select>
                             ...
                             <div class="mb-3 row">
                                 ...
                                 <div class="col-md-1 text-center mt-1 d-none d-sm-block">:</div>
                                 <div class="col-md-8 col-sm-11">
                                     <input type="text" name="ba_penangkapan_nama_tersangka[]"
                         ...
                         <p class="text-black">
                             ...
                             ……………………..(28)…………………..……..., melanggar Pasal ….…(29)…... Undang-Undang
                             …………………………..…(30)………………………….……
                         </p>
                         <p class="text-black">
                             Demikian Berita Acara Penangkapan ini dibuat dengan sebenarnya atas kekuatan sumpah
                             jabatan, kemudian ditutup dan ditandatangani di ...................(31).................
                             pada hari dan
