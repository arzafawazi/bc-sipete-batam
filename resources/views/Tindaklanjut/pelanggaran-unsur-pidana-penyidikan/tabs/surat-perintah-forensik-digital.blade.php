<div class="container-fluid mt-4">
  ...
  <div class="mb-3 row align-items-center">
    <div class="input-group flex-wrap">
      ...
      <input type="text" class="form-control" value="{{ old('no_spfd', isset($unsurpenyidikan) ? $unsurpenyidikan->no_spfd : $no_ref) }}" name="no_spfd" readonly>
      <span class="input-group-text">/PPNS/</span>
      <input type="date" class="form-control" name="tgl_spfd" value="{{ old('tgl_sppsj', isset($unsurpenyidikan) ? $unsurpenyidikan->tgl_spfd : '') }}">
    </div>
  </div>
          ...
          <div class="container-fluid px-0 px-sm-3">
            <div class="mb-3 row">
              ...
              <div class="col-md-8 col-sm-11">
                <ol class="ps-3 text-black" start="1" style="line-height: 1.5;">
                  <li class="mb-1 ps-1">Dalam rangka memperoleh data dan/atau infromasi untuk kepentingan
            ...
            <div class="col-md-8 col-sm-11">
                <ol class="ps-3 text-black" start="1" style="line-height: 1.5;">
                    ...
                    <li class="mb-1 ps-1">Surat Perintah Penyitaan Nomor : SPP- …………(11)…………. tanggal …………..(12)…………..</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-md-8 col-sm-11">
                    <ol class="ps-3 text-black" start="1" style="line-height: 1.5;">
                        <li class="mb-1 ps-1">Melakukan forensik digital terhadap:
                            ...
                            Sehubungan dengan terjadinya tindak pidana di bidang .........(20).......... yaitu ………(21)………..., diduga melanggar ……..(22)……................
                        </li>
                        <li class="mb-1 ps-1">Setelah melaksanakan surat perintah ini agar membuat Berita Acara Forensik Digital.</li>
                        <li class="mb-1 ps-1">Surat Perintah ini mulai berlaku sejak tanggal .......(23)...... sampai dengan tanggal ………(24).……..</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="mb-3 row">
              <label class="col-md-3 col-sm-12 col-form-label fw-bold text-md-start">PEJABAT YANG MENERBITKAN SURAT FORENSIK DIGITAL</label>
              <div class="col-md-1 col-sm-1 text-center mt-1 d-none d-sm-block">:</div>
              <div class="col-md-8 col-sm-11">
