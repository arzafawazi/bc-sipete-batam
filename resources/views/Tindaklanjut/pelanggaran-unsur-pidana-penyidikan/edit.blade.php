                            ...
                            <div class="card-body">
                                <div class="tabs-container" id="tabs-container">
                                    ...
                                    <ul class="nav nav-pills nav-justified flex-nowrap overflow-auto" style="white-space: nowrap;" role="tablist">
                                        ...
                                        <li class="nav-item-penyidikan">
                                            <a class="nav-link " id="navtabs2-ba-sumpah-tab" data-bs-toggle="tab" href="#navtabs2-ba-sumpah" role="tab" aria-controls="navtabs2-ba-sumpah" aria-selected="false">
                                ...
                                <div class="tab-content p-3 text-muted">
                                    ...
                                    <div class="tab-pane" id="navtabs2-baw-bap" role="tabpanel">
                                        @include('Tindaklanjut.pelanggaran-unsur-pidana-penyidikan.tabs.baw-bap', [
                                        'no_ref' => $no_ref,
                                        'nama_negara' => $nama_negara,
                                        'sbpData' => $sbpData,
                                        'users' => $users,
                                     ...
                                     <div class="tab-pane" id="navtabs2-data-ahli" role="tabpanel">
                                        @include('Tindaklanjut.pelanggaran-unsur-pidana-penyidikan.tabs.data-ahli', [
                                        'no_ref' => $no_ref,
                                        'nama_negara' => $nama_negara,
                                        'sbpData' => $sbpData,
                                        'users' => $users,
                                    ...
                                    <div class="tab-pane" id="navtabs2-ba-sumpah" role="tabpanel">
                                        @include('Tindaklanjut.pelanggaran-unsur-pidana-penyidikan.tabs.ba-sumpah', [
                                        'no_ref' => $no_ref,
                                        'nama_negara' => $nama_negara,
                                        'sbpData' => $sbpData,
                                        'users' => $users,
