  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3 mt-4">
      <div class="card-header">
        <h5 class="card-title mb-0">Laporan Pelanggaran Unsur Pidana Penyidikan</h5>
      </div>
      <div class="card-body">
        <form method="GET">
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              <label>No. Pelanggaran Unsur Pidana Penyidikan:</label>
              <input type="text" class="form-control" name="passport_number" placeholder="Keyword">
            </div>

            <div class="col-md-4 mb-3">
              <label>Tgl. Pelanggaran Unsur Pidana Penyidikan:</label>
            ...
            <div class="col-12 d-flex justify-content-center flex-wrap gap-2">
              ...
              <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#laporanInfoModal">
                <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Data Pelanggaran Unsur Pidana Penyidikan
              </button>
            ...
            <table id="fixed-header-datatable" class="table table-hover align-middle border-separate" style="border-spacing: 0 8px;">
              <thead>
                <tr class="bg-light">
                  ...
                  <th class="px-3 text-center py-3" style="width: 15%">Tanggal Kejadian Tindak Pidana Penyidikan</th>
                  ...
                  <tr class="shadow-sm">
                    ...
                    <td>
                      <div class="d-flex gap-1 justify-content-center">
                        <a href="{{ route('unsur-pidana-penyidikan.edit', ['unsur_pidana_penyidikan' => $unsurpidana->id]) }}" class="btn btn-soft-success btn-icon btn-sm rounded-pill">
                          <i data-feather="edit" class="icon-sm"></i> Edit
                        </a>
                        <form action="{{ route('unsur-pidana-penyidikan.destroy', $unsurpidana->id) }}" method="POST" class="d-inline delete-form">
                          @csrf
                          @method('DELETE')
    ...
    document.addEventListener("DOMContentLoaded", function() {
      document.addEventListener('click', function(event) {
        if (event.target.classList.contains('pilih-laporan')) {
          ...
          let url = `/Tindaklanjut/unsur-pidana-penyidikan/create?id_penyidikan=${encodeURIComponent(nomorLaporan)}`;
