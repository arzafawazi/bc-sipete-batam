@extends('layouts.vertical', ['title' => 'Pelanggaran Ketentuan Lain'])
  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3 mt-4">
      <div class="card-header">
        <h5 class="card-title mb-0">Laporan Pelanggaran Ketentuan Lain</h5>
      </div>
      <div class="card-body">
        <form method="GET">
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              <label>No. Pelanggaran Ketentuan Lain:</label>
              <input type="text" class="form-control" name="passport_number" placeholder="Keyword">
            </div>

            <div class="col-md-4 mb-3">
              <label>Tgl. Pelanggaran Ketentuan Lain:</label>
            ...
            <div class="col-12 d-flex justify-content-center flex-wrap gap-2">
              ...
              <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#laporanInfoModal">
                <i data-feather="plus" style="width: 16px; height: 16px;" class="me-1"></i> Rekam Data Pelanggaran Ketentuan Lain
              </button>
