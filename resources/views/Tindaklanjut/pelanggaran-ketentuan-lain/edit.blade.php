...
@section('content')
  <div class="container-fluid">
    <form action="{{ route('pelanggaran-ketentuan-lain.update', ['pelanggaran_ketentuan_lain' => $pelanggaranlain->id]) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
                      ...
                      <div class="container mt-4">
                        ...
                        <div class="mb-3 row align-items-center">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('no_bast_instansi_lain_pkl', $pelanggaranlain->no_bast_instansi_lain_pkl) }}" readonly>
                            <span class="input-group-text">/KPU.02/BD.06/</span>
                            <input type="date" class="form-control" name="tgl_bast_instansi_lain_pkl" value="{{ old('tgl_bast_instansi_lain_pkl', $pelanggaranlain->tgl_bast_instansi_lain_pkl) }}">
                          </div>
                        </div>
                              ...
                              <div class="col-lg-12">
                                <div class="container">
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" placeholder="Nama Orang Yang Padanya Dilakukan Serah Terima" name="nama_bast_instansi_pkl"
                                        value="{{ old('nama_bast_instansi_pkl', $pelanggaranlain->nama_bast_instansi_pkl) }}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" placeholder="Jenis Identitas Yang Padanya Dilakukan Serah Terima" name="jenis_iden_bast_instansi_pkl"
                                        value="{{ old('jenis_iden_bast_instansi_pkl', $pelanggaranlain->jenis_iden_bast_instansi_pkl) }}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" placeholder="Nomor Identitas Yang Padanya Dilakukan Serah Terima" name="iden_bast_instansi_pkl"
                                        value="{{ old('iden_bast_instansi_pkl', $pelanggaranlain->iden_bast_instansi_pkl) }}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" placeholder="Menerima penyerahan untuk/atas nama" name="atas_nama_bast_instansi_pkl"
                                        value="{{ old('atas_nama_bast_instansi_pkl', $pelanggaranlain->atas_nama_bast_instansi_pkl) }}">
                                    </div>
                                  </div>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class=" col-md-1 text-center mt-1">:</div>
                                    <div class="col-md-8">
                                      <textarea class="form-control" rows="3" placeholder="Penyerahan dilaksanakan dalam rangka" name="dilaksanakan_dalam_rangka_bast_instansi_pkl">{{ old('dilaksanakan_dalam_rangka_bast_instansi_pkl', $pelanggaranlain->dilaksanakan_dalam_rangka_bast_instansi_pkl) }}</textarea>
                                    </div>
                                  </div>
                                    ...
                                    <div class="col-md-8">
                                      <select class="form-control form-select select2" name="pejabat_menyerahkan_bast_instansi_pkl">
                                        ...
                                        @foreach ($users as $user)
                                          <option value="{{ $user->id_admin }}" {{ old('pejabat_menyerahkan_bast_instansi_pkl', $pelanggaranlain->pejabat_menyerahkan_bast_instansi_pkl) == $user->id_admin ? 'selected' : '' }}>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <select class="form-control form-select select2" name="saksi_pertama_bast_instansi_pkl">
                                        <option value="" disabled>- Pilih -</option>
                                        @foreach ($users as $user)
                                          <option value="{{ $user->id_admin }}" {{ old('saksi_pertama_bast_instansi_pkl', $pelanggaranlain->saksi_pertama_bast_instansi_pkl) == $user->id_admin ? 'selected' : '' }}>
                                            {{ $user->name }} | {{ $user->jabatan }}
                                          </option>
                                        @endforeach
                                      </select>
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-md-8">
                                      <select class="form-control form-select select2" name="saksi_kedua_bast_instansi_pkl">
                                        <option value="" disabled>- Pilih -</option>
                                        @foreach ($users as $user)
                                          <option value="{{ $user->id_admin }}" {{ old('saksi_kedua_bast_instansi_pkl', $pelanggaranlain->saksi_kedua_bast_instansi_pkl) == $user->id_admin ? 'selected' : '' }}>
                                            {{ $user->name }} | {{ $user->jabatan }}
                                          </option>
                                        @endforeach
                                      </select>
