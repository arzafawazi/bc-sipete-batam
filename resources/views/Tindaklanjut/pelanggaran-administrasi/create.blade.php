...
@section('content')
  <div class="container-fluid">
    <form action="{{ route('pelanggaran-administrasi.store') }}" method="POST">
      @csrf
                    ...
                    <ul class="nav nav-pills nav-justified flex-nowrap overflow-auto" style="white-space: nowrap;" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="navtabs2-ppftz-tab" data-bs-toggle="tab" href="#navtabs2-ppftz" role="tab" aria-controls="navtabs2-ppftz" aria-selected="true">
                          <span class="d-block d-sm-none">(PPFTZ-01)</span>
                          <span class="d-none d-sm-block">Pembuatan Dokumen PPFTZ-01</span>
                        </a>
                      </li>
                      <li class="nav-item" id="navtabs2-bdn-tab-item">
                        <a class="nav-link" id="navtabs2-bdn-tab" data-bs-toggle="tab" href="#navtabs2-bdn" role="tab" aria-controls="navtabs2-bdn" aria-selected="false">
                          <span class="d-block d-sm-none">BDN</span>
                          <span class="d-none d-sm-block">Barang Yang Dikuasai Negara (BDN)</span>
                        </a>
                      </li>
                      <li class="nav-item" id="navtabs2-reekspor-tab-item">
                        <a class="nav-link" id="navtabs2-reekspor-tab" data-bs-toggle="tab" href="#navtabs2-reekspor" role="tab" aria-controls="navtabs2-reekspor" aria-selected="false">
                          <span class="d-block d-sm-none">REEKSPOR</span>
                          <span class="d-none d-sm-block">Reekspor/Pembatalan Dokumen</span>
                        </a>
                      </li>
                      <li class="nav-item" id="navtabs2-spsa-tab-item">
                        <a class="nav-link" id="navtabs2-spsa-tab" data-bs-toggle="tab" href="#navtabs2-spsa" role="tab" aria-controls="navtabs2-spsa" aria-selected="false">
                          <span class="d-block d-sm-none">SPSA</span>
                          <span class="d-none d-sm-block">Sanksi Administrasi SPSA</span>
                        </a>
                      </li>
                      <li class="nav-item" id="navtabs2-lartas-tab-item">
                        <a class="nav-link" id="navtabs2-lartas-tab" data-bs-toggle="tab" href="#navtabs2-lartas" role="tab" aria-controls="navtabs2-lartas" aria-selected="false">
                          <span class="d-block d-sm-none">Lartas</span>
                          <span class="d-none d-sm-block">Pemenuhan Dokumen Lartas</span>
                        </a>
                      </li>
                    </ul>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          ...
                          <div class="row">
                            ...
                            <input type="hidden" class="form-control bg-primary text-white" name="id_penyidikan_ref" value="" readonly>
