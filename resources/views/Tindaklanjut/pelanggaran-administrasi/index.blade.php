              ...
              <tbody>
                {{-- @foreach ($penyidikan as $penyidikan)
                  <tr align="center">
                    ...
                    <td class="pt-3">{{ $pascapenindakan->tgl_lhp_penyidikan }}</td>
                    <td class="pt-3">
                    ...
                    <td>
                      @foreach ($sbpData as $sbp)
                        ...
                        <button type="button" class="btn btn-primary pilih-laporan" data-nomor="{{ $penyidikan->id_penyidikan }}" data-label="{{ $buttonLabel }}">
                          {{ $buttonLabel }}
                        </button>
                        <div>
