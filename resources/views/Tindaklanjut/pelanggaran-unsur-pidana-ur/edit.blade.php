...
@extends('layouts.vertical', ['title' => 'Edit Pelanggaran Unsur Pidana Penyidikan UR'])
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('unsur-pidana-ur.update', ['unsur_pidana_ur' => $unsurpenyidikanur->id]) }}"
